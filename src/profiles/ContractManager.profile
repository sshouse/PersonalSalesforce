...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <applicationVisibilities>
        <application>Follow_Up_app</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
    ...
    <classAccesses>
        <apexClass>TestDeduper</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TestFindDupes</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TestForceForecasting</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Contact.Dupe_Contact__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
